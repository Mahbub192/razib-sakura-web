        ...
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <h1 className="text-2xl font-bold text-[#111418] dark:text-white">Doctor Management</h1>
            </div>
          </div>
        </header>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {loading ? (
            <div className="text-center py-12">
              ...
              <p className="text-[#617589] dark:text-gray-400">Loading doctors...</p>
            </div>
          ) : error ? (
            <div className="text-center py-12">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-[#617589] dark:text-gray-400">No doctors found</p>
            </div>
          ) : (
            <>
                  ...
                  >
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-bold text-[#111418] dark:text-white">{doctor.fullName}</h3>
                        <p className="text-sm text-[#617589] dark:text-gray-400">{doctor.specialty}</p>
                      </div>
                    </div>
